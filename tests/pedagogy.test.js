...
test('24 situations : règles de dialogue, fiche et évaluation étayée',async()=>{
 ...
 if(action==='chat'){assert.ok(prompt.includes('ne décrit pas ce que le commercial a dit'));assert.ok(prompt.includes('ne répète pas un doute vague'));return {response:'Je dois réfléchir.'};}
