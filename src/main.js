...
<div class="offer-prep"><span class="section-label">AVANT DE COMMENCER</span><p>Préparation libre, hors chronomètre. Entretien conseillé : 5 à 8 minutes. Objectif : une prochaine étape, pas une résolution technique.</p><details open><summary>Votre fiche commerciale · à garder sous les yeux</summary><div id="offerSheet"></div></details></div><div class="session-settings"><label for="engine">Mode de simulation</label><select id="engine"><option value="demo">Aperçu sans IA · réponses limitées</option value="ai">Entretien avec l’IA</option></select><p id="engineNote">Réponses prédéfinies pour essayer les avatars. Pas d’évaluation pédagogique.</p><div id="accessWrap" hidden><label for="accessCode">Code de session fourni par le formateur</label><input id="accessCode" type="password" autocomplete="off" maxlength="128" placeholder="Votre code de session"></div></div>
